    ...
    
    {
      ...
      "days": [
        ...
        },
        {
          ...
          "description": "Detailed 150-word description of Day 2 activities, specific to ${name}",
          "morningActivity": "Specific morning activity with location name in ${name}",
          "afternoonActivity": "Specific afternoon activity with location name in ${name}",
          "eveningActivity": "Specific evening activity or dining with location name in ${name}"
        },
        {
          "day": 3,
          "title": "Day 3 title focusing on another aspect of ${name}",
          "description": "Detailed 150-word description of Day 3 activities, specific to ${name}",
          "morningActivity": "Specific morning activity with location name in ${name}",
          "afternoonActivity": "Specific afternoon activity with location name in ${name}",
          "eveningActivity": "Specific evening activity or dining with location name in ${name}"
        },
        {
          "day": 4,
          "title": "Day 4 title focusing on a different aspect of ${name}",
          "description": "Detailed 150-word description of Day 4 activities, specific to ${name}",
          "morningActivity": "Specific morning activity with location name in ${name}",
          "afternoonActivity": "Specific afternoon activity with location name in ${name}",
          "eveningActivity": "Specific evening activity or dining with location name in ${name}"
        },
        {
          "day": 5,
          "title": "Day 5 title focusing on another aspect of ${name}",
          "description": "Detailed 150-word description of Day 5 activities, specific to ${name}",
          "morningActivity": "Specific morning activity with location name in ${name}",
          "afternoonActivity": "Specific afternoon activity with location name in ${name}",
          "eveningActivity": "Specific evening activity or dining with location name in ${name}"
        },
        {
          "day": 6,
          "title": "Day 6 title focusing on a different aspect of ${name}",
          "description": "Detailed 150-word description of Day 6 activities, specific to ${name}",
          "morningActivity": "Specific morning activity with location name in ${name}",
          "afternoonActivity": "Specific afternoon activity with location name in ${name}",
          "eveningActivity": "Specific evening activity or dining with location name in ${name}"
        },
...
// Function to add a single itinerary to a specific destination
async function addSingleItinerary() {
  try {
    console.log("Starting to add a single 7-day itinerary...");
    
    // Destination to add an itinerary for - let's pick Prague which doesn't have one yet
    ...
    console.error("Error adding a single 7-day itinerary:", error);
  }
}

// Run the function
addSingleItinerary().then(() => process.exit(0)).catch(error => {
  console.error("Failed to add a single 7-day itinerary:", error);
  process.exit(1);
});